...
public class EMRLauncher extends Intent {
     ...
     * @param examinationData The {@linkplain java.util.ArrayList}<{@linkplain java.lang.String}> of examination data generated by the Vscan application.
     */
    public EMRLauncher(Context context, ArrayList<String> images, ArrayList<String> examinationData) {
        super(context.getPackageManager().getLaunchIntentForPackage("org.royrvik.capgeminiemr"));
     ...
     * @param examinationData The {@linkplain java.util.ArrayList}<{@linkplain java.lang.String}> of examination data generated by the Vscan application.
     */
    public EMRLauncher(Context context, ArrayList<String> images, ArrayList<String> patientData, ArrayList<String> examinationData) {
        super(context.getPackageManager().getLaunchIntentForPackage("org.royrvik.capgeminiemr"));
