...
public class PDFCreator {
    ...
    private static void addTitlePage(Document document)throws DocumentException {
        ...
        preface.add(new Paragraph("Report generated by Vscan user:  " + username + ", " + new Date(),
                smallerBold));
        addEmptyLine(preface, 1);
        addEmptyLine(preface, 1);
        ...
        phrase.add(new Chunk(formattedDate(Long.parseLong(examinationdata.get(4))), smallerItalic));
        cell = new PdfPCell(phrase);
        cell.disableBorderSide(Rectangle.BOX);
        tbl.addCell(cell);
        //
